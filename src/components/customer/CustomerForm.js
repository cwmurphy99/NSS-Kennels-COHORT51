...
export const CustomerForm = () => {
	...
	const [customers, setAnimals] = useState([]);
	...
	return (
		<form className="customerForm">
			...
			<fieldset>
				<div className="form-group">
					<label htmlFor="breed">Cusomer Address:</label>
					<input type="text" id="address" onChange={handleControlledInputChange} required autoFocus className="form-control" placeholder="Customer address" value={customer.breed} />
				</div>
			</fieldset>
			<fieldset>
				<div className="form-group">
